...
public class EmployeeTest {
	...
	public static void main(String args[]) {
		...
		System.out.println("###################################");
		SalariedEmployee salariedEmployee = new SalariedEmployee("Joao", "Vicente", "111-11-1111", new Date(5, 11, 1984),
				800.00);
		HourlyEmployee hourlyEmployee = new HourlyEmployee("Karla", "Fabiana", "222-22-2222", new Date(6, 15, 1988),
				16.75, 40);
		CommissionEmployee commissionEmployee = new CommissionEmployee("Jose", "Silva", "333-33-3333",
		...
		//PieceWorker pieceWorker = new PieceWorker("Rafael", "oliveira", "777-223-987", new Date(6, 25, 1985), 213, 16);
