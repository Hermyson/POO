...
public class Date {
	// Constantes com os mese do ano e fevereiro com 29 dias
	...
	private static final String[] strDays = { "", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday",
			"Sunday" };

	private int[] date = new int[3];

	// Primeiro construtor com tres inteiros
	...
	// Segundo construtor com um string e dois inteiros
	...
	// Terceiro construtor com dois inteiros e o dias no ano
